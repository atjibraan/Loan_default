...
def get_user_input():
    with st.form("loan_input"):
        ...
        income = col2.number_input("Annual Income ($)", 1000, 500000000, 600000000000)
        loan_amount = col3.number_input("Loan Amount ($)", 500, 200000000, 200000000000000)
...
def chatbot_interface(artifacts):
    ...
    conversation_steps = [
        ...
        {"question": "What is your annual income per annum?", "field": "Income", "type": "number", "min": 1000, "max": 500000},
